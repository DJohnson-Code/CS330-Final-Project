...
{
	// save the first mouse position before moving the camera
	if (gFirstMouse)
	{
		gLastX = xMousePos;
		gLastY = yMousePos;
...
void ViewManager::PrepareSceneView()
{
	...
	{
		// use a straight-on view for orthographic projection
		view = glm::lookAt(
			glm::vec3(0.0f, 2.2f, 10.0f),
			glm::vec3(0.0f, 2.2f, 0.0f),
			glm::vec3(0.0f, 1.0f, 0.0f));

		projection = glm::ortho(-6.0f, 6.0f, -4.0f, 4.0f, 0.1f, 100.0f);
	}
	else
	{
